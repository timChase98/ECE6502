...
set_property -dict {PACKAGE_PIN M3 IOSTANDARD LVCMOS33} [get_ports {address[9]}]
set_property -dict {PACKAGE_PIN L3 IOSTANDARD LVCMOS33} [get_ports {address[10]}]
set_property -dict {PACKAGE_PIN A16 IOSTANDARD LVCMOS33} [get_ports {address[11]}]
...
set_property -dict { PACKAGE_PIN H1    IOSTANDARD LVCMOS33 } [get_ports { via_csb }]; #IO_L3P_T0_DQS_AD5P_35 Sch=pio[06]
...
set_property -dict {PACKAGE_PIN U1 IOSTANDARD LVCMOS33} [get_ports {rw}]
